...
export default function InstructorDashboard() {
  ...
  const quickActions = [
    { label: "Schedule a Class", icon: Calendar, path: "#", color: "bg-primary" },
    { label: "Upload Material", icon: Upload, path: "#", color: "bg-secondary" },
    { label: "Review Assignments", icon: Target, path: "#", color: "bg-slate-800" },
    { label: "Message Students", icon: MessageSquare, path: "#", color: "bg-blue-600" },
  ];
    ...
    <div className="flex min-h-screen bg-muted/30">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <header className="bg-background border-b border-border px-8 py-6 sticky top-0 z-20 flex justify-between items-center text-foreground">
          <div>
            <h1 className="text-2xl font-black tracking-tight">Tutor Portal</h1>
            <p className="text-muted-foreground font-medium">Manage your students and classes.</p>
          </div>
          ...
          <div className="bg-[#181059] rounded-[2.5rem] p-10 md:p-14 text-white relative overflow-hidden shadow-2xl">
             ...
             <div className="relative z-10 space-y-6 max-w-2xl">
                ...
                <div className="flex flex-wrap gap-4">
                   ...
                   <button className="px-8 py-4 bg-white/10 backdrop-blur-md rounded-2xl font-black hover:bg-white/20 transition-all text-xs uppercase tracking-widest">
                      Platform Reports
                   </button>
                </div>
             </div>
          ...
          <div className="space-y-6">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {quickActions.map((action, i) => (
                   <button
                     key={i}
                     className="group flex flex-col items-center gap-4 p-8 bg-background border border-border rounded-3xl hover:border-primary transition-all shadow-sm hover:shadow-2xl hover:shadow-primary/5"
                   >
          ...
          <div className="grid lg:grid-cols-3 gap-10">
             <div className="lg:col-span-2 space-y-8">
                <div className="flex justify-between items-center px-2">
                   ...
                   <button className="text-primary font-bold text-sm flex items-center gap-2">Manage All <ChevronRight size={16} /></button>
                </div>
                ...
                <div className="space-y-6">
                   {[
                     ...
                     { title: "Visual Communication Basics", students: 38, nextClass: "Tomorrow, 02:00 PM", status: "Active" },
                      ...
                      <div key={i} className="p-8 bg-background border border-border rounded-[2.5rem] flex flex-wrap items-center justify-between gap-6 group hover:border-primary transition-all">
                         <div className="flex gap-6 items-center">
                            <div className="w-16 h-16 rounded-2xl bg-secondary/10 flex items-center justify-center text-primary shadow-sm group-hover:scale-110 transition-transform">
                               <BookOpen size={30} />
                            </div>
                            <div>
                         ...
                         <div className="flex gap-3">
                            <button className="w-12 h-12 rounded-xl bg-muted flex items-center justify-center text-muted-foreground hover:bg-primary/10 hover:text-primary transition-all">
                               <Edit3 size={20} />
                            </button>
                            <button className="px-6 py-3 bg-primary text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-primary/20">
                               Manage Course
                            </button>
                         </div>
                      </div>
             ...
             <div className="space-y-8">
                <div className="flex justify-between items-center px-2">
                   <h3 className="text-2xl font-black tracking-tight">Student Submissions</h3>
                </div>
                ...
                <div className="bg-background rounded-[2.5rem] border border-border overflow-hidden p-2">
                   <div className="space-y-2">
                      {[
                        ...
                        { name: "Sarah O.", task: "Visual Style Guide", date: "1h ago" },
                        { name: "Blessing E.", task: "User Interview Report", date: "3h ago" },
                        { name: "John D.", task: "Mobile App Persona", date: "5h ago" },
                      ].map((sub, i) => (
