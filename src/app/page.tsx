...
export default function Landing() {
  ...
  const courses = [
    ...
    { title: "Cybersecurity", category: "IT", icon: Shield, image: "https://images.unsplash.com/photo-1510511459019-5efa32338ecb?auto=format&fit=crop&w=600&q=80", desc: "Protect the digital world. Learn the fundamentals of network security, ethical hacking, and data protection strategies." },
